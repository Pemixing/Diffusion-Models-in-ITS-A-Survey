...
| **LADM** [\[Lv et al. 2024\]](https://ieeexplore.ieee.org/document/10466609) | human trajectory prediction, speed up | conditioned on coarse future trajectory | DDPM | ETH et al. | 2024 TIM | —— |
...
| Paper | Task | Denoising Condition | Architecture | Datasets | Year | Open Source |
|-------|------|----------------------|--------------|----------|------|--------------|
| **KSTDiff** [\[Zhou et al. 2023\]](https://dl.acm.org/doi/abs/10.1145/3589132.3625641?casa_token=Vl9asx8D27IAAAAA:beCa2_N0zcxUer9lqT4Es1mq54p8zfeUIS3LgRBKPjd_Bx3Ucm5rPnk_W9K6tWIoe7yLofZWW-Hm2A) | traffic flow generation | conditioned on urban knowledge graph, region feature, volume estimator | CARD | real-world dataset | 2023 SIGSPATIAL | [KSTDiff](https://github.com/tsinghua-fib-lab/KSTDiff-Urban-flow-generation) |
